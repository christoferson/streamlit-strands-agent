...
chat_stream_ds_page = st.Page("views/chat_stream_data_science.py", title="Chat (Stream) DS", icon=":material/add_circle:")
...
pg = st.navigation([chat_page, chat_stream_page, chat_stream_ds_page, boto_converse_stream_page,
